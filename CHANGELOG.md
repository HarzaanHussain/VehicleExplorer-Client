...
- Create Angular project with ng: `ng new vehicleexplorer.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`vehicleexplorer.client.esproj`).
